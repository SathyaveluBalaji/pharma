...
public class removepatient extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String remo="delete from patients where patientID='"+ ID +"';";
			preparedStatement.executeUpdate(remo);
		...
		pw.println("<center><u><b><br><a href='removepatient.jsp'>Back</a></b></u><center>");
	}
}